...
-- 시험지4 1~3번 문제
Insert INTO exam_paper_multiple_questions(exampaper_id, no, point, content, comment, createdate, updatedate)
VALUES (4, 1, 20, '4-1번 문제', '설계된 화면과 폼의 흐름을 확인할 수 있다.', now(), now());
Insert INTO exam_paper_multiple_questions(exampaper_id, no, point, content, comment, createdate, updatedate)
VALUES (4, 2, 20, '4-2번 문제', '설계된 화면과 폼의 흐름을 확인할 수 있다.', now(), now());
Insert INTO exam_paper_multiple_questions(exampaper_id, no, point, content, comment, createdate, updatedate)
VALUES (4, 3, 20, '4-3번 문제', '설계된 화면과 폼의 흐름을 확인할 수 있다.', now(), now());
