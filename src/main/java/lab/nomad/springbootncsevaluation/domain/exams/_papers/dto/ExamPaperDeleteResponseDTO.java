...
@Getter
public class ExamPaperDeleteResponseDTO {
    private ExamPapersDTO examPaper;

    // 생성자
    public ExamPaperDeleteResponseDTO(ExamPapers examPaper) {
    ...
    public static class ExamPapersDTO {
        ...
        private ExamPaperSaveResponseDTO.UserDTO userDTO;
        private ExamPaperSaveResponseDTO.AbilityUnitDTO abilityUnitDTO;
        ...
        public ExamPapersDTO(ExamPapers examPaper) {
            ...
            this.deleteDate = examPaper.getDeleteDate();
            this.userDTO = new ExamPaperSaveResponseDTO.UserDTO(examPaper.getUser());
            this.abilityUnitDTO = new ExamPaperSaveResponseDTO.AbilityUnitDTO(examPaper.getAbilityUnit());
        }
    }
