...
@Getter
public class ExamPaperMultipleQuestionsSaveResponseDTO {
    private ExamPaperMultipleQuestionsDTO examPaperMultipleQuestion;

    // 생성자
    public ExamPaperMultipleQuestionsSaveResponseDTO(ExamPaperMultipleQuestions examPaperMultipleQuestion) {
        this.examPaperMultipleQuestion = new ExamPaperMultipleQuestionsDTO(examPaperMultipleQuestion);
    }
